...
def add_command():
	...
	list1.delete(0,END)
	list1.insert(END,"success fully added record: "+title_text.get())

def delete_command():
	item=selected_tuple[0]
	backend.delete(item)
	list1.delete(0,END)
	list1.insert(END,"success fully deleted record: "+title_text.get())


def update_command():
	backend.update(selected_tuple[0],title_text.get(),author_text.get(),year_text.get(),isbn_text.get())
	list1.delete(0,END)
	list1.insert(END,"success fully Updated record")
